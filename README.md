...
A user approached our window and activated a touch sensor that would then send a value to Arduino which finally sent it to the Unity game in order to activate a certain animation. Based on what value the user received, each animation would be different. 
